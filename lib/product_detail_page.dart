...
class ProductDetailPage extends StatefulWidget {
  ...
  const ProductDetailPage({Key? key, this.id="a", this.name="a", this.code="a", this.img="a", this.price="A", this.promotionPrice="a", this.size=const [1], this.color=const [1]}) : super(key: key);
  @override
